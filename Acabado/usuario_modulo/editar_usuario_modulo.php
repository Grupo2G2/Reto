...
<!--------------------DATOS ACTUALES-------------------->
	...
	<div id="datosActuales">
		...
		<table id="tabla_usuarios_modulos" border="1">
			<tr>
				<th>Curso</th>
				<th>Centro</th>
				<th>Ciclo</th>
	...
	$(document).ready(function(){
		...
		$("#botonMostrar").click(function(){
    		...
    		//SI SE HAN SELECCIONADO TODOS LOS PARÁMETROS.
		        ...
		        $('#tabla_usuarios_modulos').css("display","block");


		        //RELLENA LA TABLA CON LOS USUARIOS ASIGNADOS A MÓDULOS.
		        $('#tabla_usuarios_modulos').append($('<tr class="contenido"><td id="datosCurso">'+$("#select_curso option:selected").text()+'</td><td id="datosCentro">'+"<?php echo $usuario->result()[0]->DESC_Centro; ?>"+'</td><td id="datosCiclo">'+$("#select_ciclo option:selected").text()+'</td><td id="datosModulo">'+$("#select_modulo option:selected").text()+'</td><td id="datosTipoUsuario">'+"<?php echo $usuario->result()[0]->DESC_TUsuario; ?>"+'</td><td id="datosUsuario">'+"<?php echo $usuario->result()[0]->User; ?>"+'</td><td>'+"<?php echo $usuario->result()[0]->Nombre; ?>"+'</td><td>'+"<?php echo $usuario->result()[0]->Apellidos; ?>"+'</td></tr>'));
		...
		$("#botonEditar").click(function(){
		    ...
		    $.post({url: "<?php echo base_url(); ?>index.php/Usuario_Modulo/guardar_cambios_usuario_modulo/<?php echo $usuario->result()[0]->ID_Usuario_Modulo; ?>",
		    datatype:"json",
