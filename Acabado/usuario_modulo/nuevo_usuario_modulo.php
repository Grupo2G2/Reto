<div>
	...
	<table id="tabla_usuarios_modulos_tipo" border="1">
		<tr>
			<th>Curso</th>
			<th>Centro</th>
			<th>Ciclo</th>
	...
	<!--------------------BOTÓN AÑADIR RELACIÓN USUARIO-MODULO-------------------->
	
	
	<button id="botonCrear">Crear</button>
	

	<!--------------------FIN BOTÓN AÑADIR RELACIÓN USUARIO-MODULO-------------------->
	...
	$(document).ready(function(){
		...
		$("#botonMostrar").click(function(){
    		...
    		//SI SE HAN SELECCIONADO TODOS LOS PARÁMETROS.
		        ...
		        success: function(devuelto){
		        $('#tabla_usuarios_modulos_tipo').css("display","block");
